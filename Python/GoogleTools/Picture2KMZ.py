...
from types import *
#import curses.ascii
Picture_path=r"D:\Python\pictures"
info_file=r'D:\Python\pictures\picture_info.xml'

dom=minidom.parse(info_file)
...
new_dom = impl.createDocument(None, 'catalog', None)
root = dom.documentElement
