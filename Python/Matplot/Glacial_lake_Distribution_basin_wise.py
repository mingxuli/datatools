...
if __name__ == "__main__":
    ...
    plt.scatter(points_x,points_y,s=Area,marker='o',c='r',label='glacial lake area')
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    
    plt.text(80,26.2,'a. All Type',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    plt.scatter(86,29.0,s=100,marker='o',c='r')
    plt.text(86.2,28.7,' 10 $km^2$')
    plt.xlim(79.5,88.5)
    plt.xlim(79.5,88.5)
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'b. Glacial erosion lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'c. End moraine dammed lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'d. Lateral moraine dammed lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'e. Glacier with lateral moraine dammed lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'f. Other moraine dammed lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'g. Supra-glacial lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
    ...
    plt.xlabel('longitude')
    plt.ylabel('latitude')
    plt.text(80,26.2,'h. Non-glacial lake',fontsize=12)
    plt.scatter(86,30.0,s=1,marker='o',c='r')
    plt.text(86.2,29.8,'0.1 $km^2$')
    plt.scatter(86,29.5,s=10,marker='o',c='r')
    plt.text(86.2,29.3,'   1 $km^2$')
