...
if __name__ == "__main__":
    ...
    curs=conn.cursor()
    sql_str="delete from \"Nepal_Glacial_Lake_Link_01_09\""
    ...
    for gid_01,Code_01 in records:
        ...
        if len(rows)>0:
            for gid_09,Code_09 in rows:
                sql_insert="INSERT INTO \"Nepal_Glacial_Lake_Link_01_09\""\
            ...
            if len(rows_2)>0:
                for gid_09,Code_09 in rows_2:
                    sql_insert_1="INSERT INTO \"Nepal_Glacial_Lake_Link_01_09\""\
                                +"(gid_2001,code_01,area_01,class_01,new_class_01,gid_2009,code_09,area_09,class_09,remarks)"\
                ...
                if len(rows_3)>0:
                    for gid_09,Code_09 in rows_3:
                        sql_insert_2="INSERT INTO \"Nepal_Glacial_Lake_Link_01_09\""\
                                    +"(gid_2001,code_01,area_01,class_01,new_class_01,gid_2009,code_09,area_09,class_09,remarks)"\
                                    +" select a.gid,a.\"Gl_Code\",a.\"Gl_Area\",a.\"Gl_Class\",a.new_class,"\
                    ...
                    sql_insert_3="INSERT INTO \"Nepal_Glacial_Lake_Link_01_09\"(gid_2001,code_01,area_01,class_01,new_class_01,remarks)"\
    ...
    conn.commit()
    gid_list=''
    sql_str="SELECT gid_2009,count(gid_2009) FROM \"Nepal_Glacial_Lake_Link_01_09\" where gid_2009 is not null group by gid_2009 order by gid_2009;"
    curs.execute(sql_str)    
    ...
    sql_insert_4="insert into \"Nepal_Glacial_Lake_Link_01_09\"(gid_2009,code_09,area_09,class_09,remarks)"\
    ...
    sql_update="update \"Nepal_Glacial_Lake_Link_01_09\" set remarks='Supra_Lake' where class_09='IS' or new_class_01='S';"
    curs.execute(sql_update)
    sql_update_1="update \"Nepal_Glacial_Lake_Link_01_09\" set change=remarks;"
    curs.execute(sql_update_1)
    ## mark split
    gid_list=''
    sql_select="select gid_2001,count(gid_2001) from \"Nepal_Glacial_Lake_Link_01_09\" group by gid_2001 having count(gid_2001)>1;"
    ...
    gid_list='('+gid_list+')'
    gid_list=gid_list.replace('(,','(')
    sql_update_2="update \"Nepal_Glacial_Lake_Link_01_09\" set change='Split' where gid_2001 in "+gid_list+';'
    curs.execute(sql_update_2)
    ##mark merge lake
    gid_list=''
    sql_select="select gid_2009,count(gid_2009) from \"Nepal_Glacial_Lake_Link_01_09\" group by gid_2009 having count(gid_2009)>1;"
    curs.execute(sql_select)
    ...
    gid_list='('+gid_list+')'
    gid_list=gid_list.replace('(,','(')
    sql_update_3="update \"Nepal_Glacial_Lake_Link_01_09\" set change='Merge' where gid_2009 in "+gid_list+';'
    curs.execute(sql_update_3)
    sql_update_4="update \"Nepal_Glacial_Lake_Link_01_09\" set change='Same Lake' where change='Split_1' or change='overlaps_1' or change='Merge_1';"
